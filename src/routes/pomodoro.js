...
import Usuario from "../../public/js/app/models/Usuarios.js"; // importa o model do usuário
...
router.post("/login", function (req, res) {
  ...
  if (erros.length > 0) {
    res.render("pomodoro/login", { erros: erros }); // envia os erros para a página
  } else {
    Usuario.findOne({ email: req.body.email }) //ta dando pau aqui o que sera???????
